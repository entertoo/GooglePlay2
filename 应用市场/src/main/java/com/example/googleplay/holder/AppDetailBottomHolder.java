...
public class AppDetailBottomHolder extends BaseHolder<AppInfoBean> implements OnClickListener, DownloadStateObserver {
    ...
    @BindView(R.id.app_detail_download_btn_favo) Button mBtnFavo;
    @BindView(R.id.app_detail_download_btn_share) Button mBtnShare;
    @BindView(R.id.app_detail_download_btn_download) ProgressButton mBtnDownload;
