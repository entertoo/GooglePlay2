...
public class AppItemHolder extends BaseHolder<AppInfoBean> implements DownloadStateObserver {
     ...
     */
    @BindView(R.id.item_appinfo_iv_icon) ImageView mIvIcon;
    @BindView(R.id.item_appinfo_tv_title) TextView mTvTitle;
    @BindView(R.id.item_appinfo_rb_stars) RatingBar mRbStars;
    @BindView(R.id.item_appinfo_tv_size) TextView mTvSize;
    @BindView(R.id.item_appinfo_tv_des) TextView mTvDes;
    @BindView(R.id.item_appinfo_circleprogress) CircleProgressView mCircleProgressView;
